...
class LanguageController extends Controller
{
     ...
     * @Template()
     */
    public function switchAction(Request $request, $route, array $params = array(), array $translatables = array())
    {
    ...
    protected function validateTranslatables(array $translatables)
    {
        foreach ($translatables as $translatable) {
            if (!$translatable instanceof TranslatableInterface) {
                throw new InvalidTypeException('BehaviorBundle\\Model\\TranslatableInterface', get_class($translatable));
            }
        }
    }
