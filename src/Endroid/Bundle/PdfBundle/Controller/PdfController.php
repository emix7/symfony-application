...
class PdfController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        if ($this->get('request')->query->get('ids')) {
            $html = $this->addFilters($html, explode(',', $this->get('request')->query->get('ids')));
        }
    ...
    public function coverAction($forceRebuild = false)
    {
        ...
        $response = $this->render('EndroidPdfBundle:Pdf:cover.html.twig', array(
            'title' => 'PDF Document',
    ...
    public function tocAction($forceRebuild = false)
    {
        ...
        $response = $this->render('EndroidPdfBundle:Pdf:toc.xml.twig');
    ...
    public function contentAction($forceRebuild = false)
    {
        ...
        $response = $this->render('EndroidPdfBundle:Pdf:content.html.twig', array(
            'intro' => $intro,
            'items' => $items
        ));
    ...
    public function headerAction($forceRebuild = false)
    {
        ...
        $response = $this->render('EndroidPdfBundle:Pdf:header.html.twig');
    ...
    public function footerAction($forceRebuild = false)
    {
        ...
        $response = $this->render('EndroidPdfBundle:Pdf:footer.html.twig');
    ...
    {
        $replaces = array(
            '/bundles/endroidpdf/' => 'file://'.$this->get('kernel')->getRootDir().'/../web/bundles/endroidpdf/'
        );
    ...
    public function addFilters($html, $ids = array())
    {
        ...
        return str_replace('<!-- FILTERS -->', '<style>'.implode(' ', $filters).'</style>', $html);
    }
}
